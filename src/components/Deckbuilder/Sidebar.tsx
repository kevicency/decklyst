...
export const Sidebar: FC<{
  ...
  return (
    <div className="flex w-72 shrink-0 flex-col gap-y-2 border-l border-gray-700 bg-alt-900 p-2 pt-4">
      ...
      <div className="-mx-2 -mb-2 grid grid-cols-2 gap-2 border-t border-alt-600 bg-gray-900 px-2 py-2">
      ...
      <div className="-mx-2 -mb-2 border-t border-alt-600 bg-gray-900 px-1">
        <input
          className="page-header-input w-full bg-gray-900 px-4 text-alt-200"
          readOnly
          value={deck.deckcode}
          onChange={noop}
