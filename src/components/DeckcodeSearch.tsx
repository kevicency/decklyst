...
export const DeckcodeSearch: FC<{ big?: boolean }> = ({ big }) => {
  ...
  return (
    <div className={cx('relative flex', big ? 'w-full' : 'w-96', big ? 'h-16' : 'h-auto')}>
      <input
        ref={inputElement}
        className={cx(
          'w-64 flex-1 border-2 border-alt-700 bg-alt-900 pl-4',
      ...
      <button
        ...
        className={cx(
          'btn disabled:bg-alt-900 disabled:text-alt-500',
